...
The clerks are under heavy development, not ready for use. But once it is, it shall replace our 2 spree installations.
 ...
 * "MarketStree":https://github.com/alex-nexus/market_street/ has taken the ball from ror-e and is running strong with an impressive list of goals
 * "TryShopp":http://tryshoppe.com/ is new and lightweight. Very nice looking interface.
